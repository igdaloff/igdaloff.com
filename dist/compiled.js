(function () {
...
})()(
  {
    ...
    11: [
      ...
      { '../cancel/Cancel': 4, '../cancel/isCancel': 6, '../defaults': 16, './../utils': 30, './transformData': 15 }
    ],
    12: [
      function (require, module, exports) {
        'use strict';
        ...
        axios
          ...
          .then(function (response) {
            ...
            const playerTemplate = html`
              <div
                class="player text-sm sm:w-[300px] border border-black border-solid shadow-[4px_4px_5px_rgba(0,0,0,0.25)]">
                <div class="player-inner p-1 flex gap-2 items-center justify-start">
                  ...
                  <a href="${trackUrl}" class="flex no-underline flex-col max-w-[60%]">
                    <span class="font-bold text-nowrap text-ellipsis overflow-hidden sm:hover:underline"
                      >${artistName}</span
                    >
